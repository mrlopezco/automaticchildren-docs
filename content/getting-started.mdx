...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Organization Settings > Automatic Children — showing the plans table (Trial, Starter, Team, Business, Enterprise) and the Licensed Projects section.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Project Settings > Automatic Children — General tab showing the rules list (can be empty) and the Add Rule button.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Rule editor showing the name "Tasks for User Story", the trigger set to User Story, and a child Task item with Title mapped to `Task for {{System.Title}}`. Highlight the placeholder button.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Work item context menu with "Automatic Child Items" highlighted.
</Callout>

<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Side panel showing the "Run rules" preview with child items listed and the Create button.
</Callout>
