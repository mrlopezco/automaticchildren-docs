...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** A field mapping row with the placeholder button highlighted. The dropdown is open, showing the "Common" section (Title, State, Assigned To, Area Path, Iteration Path) and the "Details" section (Priority, Tags, Description, etc.). The search box is visible at the top.
</Callout>
