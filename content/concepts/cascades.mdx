...
![Cascades Overview Screenshot](/docs/screenshots/concepts/cascades/cascade-overview.png)
...
| Level | Input (runs on) | What runs | Output (creates) |
|-------|-----------------|-----------|------------------|
| Start | Epic | — | Epic (you open this) |
| Master rule | Epic | "Features for Epic" | Features |
| Stage 1 | Each Feature | "Stories for Feature" | User Stories |
| Stage 2 | Each User Story | "Tasks for Story" | Tasks |
...
![Cascades Editor Screenshot](/docs/screenshots/concepts/cascades/cascade-editor.png)
...
![Cascades Running Sidebar Screenshot](/docs/screenshots/concepts/cascades/sidebar_execution_cascade.png)
