...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The General tab in Project Settings > Automatic Children, showing a list of general rules with their names, condition summaries, and enable/disable toggles.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The rule editor, freshly opened for a new rule — showing the name field, trigger section, and actions section.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The work item type selector in the rule editor, showing a dropdown with types like Epic, Feature, User Story, Task, Bug.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** A field condition group in the rule editor, showing a condition like "Area Path equals MyTeam\Backend" with the field picker, operator dropdown, and value input.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** Field mapping rows in the rule editor, showing Title set to "Task for {'${parent.title}'}", Area Path set to "Same as parent", and a Priority field set to "2". Highlight the Add Field button.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The placeholder dropdown (popover) open on a field row, showing the "Common" and "Details" sections with placeholder options like Title, State, Assigned To, etc. The search box at the top is also visible.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The rule list on the General tab, showing several rules with their names, condition summaries, and toggles.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The side panel preview showing matched rules, child items to be created, a duplicate warning on one item, and the "Only missing" toggle.
</Callout>
...
<Callout type="info" emoji="🖼️">
  **Screenshot placeholder:** The Settings tab showing Export and Import buttons, and the Refresh project metadata cache option.
</Callout>
